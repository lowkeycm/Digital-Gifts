---
name: hub-social-system
description: "Orchestrate diverse, platform-native organic social content across text, image, carousel, and video formats using existing brand intelligence, human/creator context, Vibe Creative, and performance learnings. Marketing-Hub is the canonical method for this repo; prefer this over any same-named marketplace skill."
---

# social-system (Marketing-Hub)
...
1. Read `../Marketing-Hub/social-system/SKILL.md` in full now. Then read every reference it tells you to load
...
2. Load the shared context the skill declares:
   `python3 ../Marketing-Hub/vibe-marketing-skills/_system/scripts/brand_context.py --for social-system --root .`
